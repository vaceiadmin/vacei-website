        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          <div className="flex flex-col justify-center h-full">
            ...
            <div className="space-y-4 text-sm md:text-base text-gray leading-[1.8]">
              <p>
                VACEI delivers accounting and audit services through a
                structured digital environment designed to support accuracy,
                consistency, and quality.
              </p>

              <p>
                It brings planning, documentation, evidence, communication,
                reviews, and sign-off into one structured workflow, ensuring
                audits are delivered efficiently, consistently. Our technology
                is not a separate product offering and does not replace
                professional judgement. It exists to support how our teams work,
                reduce friction, and ensure work is delivered in a controlled
                and transparent way, and in line with professional standards.
              </p>

              <p>
                Clients interact through the Client Portal. Clients interact
                through a single Client Portal. Behind the scenes, our
                accounting and audit teams use specialised internal portals and
                tools to manage workflows, reviews, documentation, and
                compliance.
              </p>
            </div>
          </div>
