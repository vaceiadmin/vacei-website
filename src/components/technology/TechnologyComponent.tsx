        ...
        <section className="py-16 lg:py-24">
            <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
                ...
                <div className="text-center mb-8 sm:mb-10 lg:mb-12">
                    ...
                    {/* Main Title */}
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-[#181C42] mb-3 sm:mb-3.5 lg:mb-4">
                        Technology Component
                    </h2>
                    
                    {/* Description */}
                    <p className="text-sm sm:text-base md:text-lg lg:text-lg text-[#52525B] max-w-3xl mx-auto px-2 sm:px-0">
                    ...
                    {technologyCards.map((card) => (
                        ...
                        >
                            ...
                            <div className="mb-5 sm:mb-5.5 lg:mb-6 flex-shrink-0 h-[56px] sm:h-[60px] lg:h-[64px] flex items-center">
                                <div className="w-[56px] h-[56px] sm:w-[60px] sm:h-[60px] lg:w-[64px] lg:h-[64px] bg-[#EFF0F6] rounded-lg flex items-center justify-center p-2 sm:p-2.5 lg:p-2.5">
                                    <Image
                                        src={card.image}
                                        alt={card.title}
                                        width={48}
                            ...
                            {/* Title - Fixed Height */}
                            <h3 className="text-lg sm:text-xl lg:text-xl font-medium text-[#181C42] mb-3 sm:mb-3.5 lg:mb-4 flex-shrink-0 h-[48px] sm:h-[50px] lg:h-[52px] flex items-start">
                                {card.title}
                            </h3>

                            {/* Description - Flexible Height */}
                            <p className="text-xs sm:text-sm lg:text-base text-[#52525B] leading-relaxed mb-5 sm:mb-5.5 lg:mb-6 flex-grow min-h-[100px] sm:min-h-[110px] lg:min-h-[120px]">
                                {card.description}
                            </p>
                            ...
                            <div className="flex items-center gap-2 mt-auto flex-shrink-0 cursor-pointer group h-[28px] sm:h-[30px] lg:h-[32px]">
                                <span className="text-[#6F74B8] font-semibold text-xs sm:text-sm lg:text-base group-hover:underline">
                                    Read More
                                </span>
                                <div className="w-7 h-7 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full bg-[#6F74B8] flex items-center justify-center group-hover:bg-[#5a5f9a] transition-colors">
