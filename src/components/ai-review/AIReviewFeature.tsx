          ...
          >
            <div className="w-full max-w-[480px] grid grid-cols-1 md:grid-cols-2 gap-5 auto-rows-min">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm flex flex-col gap-5 h-full">
                ...
                <button className="mt-auto w-full py-2.5 bg-primary hover:bg-hero transition-all rounded-lg text-white text-[11px] font-semibold shadow-md shadow-primary-blue active:scale-[0.98]">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm md:col-span-2 mt-1">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <div className="flex items-center justify-between p-2.5 bg-white rounded-lg border border-input/80 shadow-[0_1px_3px_rgba(0,0,0,0.02)] hover:border-input transition-colors">
