            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
                ...
                {showHeader && (
                    <div className="text-center mb-14 lg:mb-16">
                        <SectionBadge
                            text="How it works"
                            className={isDark ? 'border-white/60 text-white/80' : 'border-[#6F74B8] text-heading'}
                        />
                        <h2
                ...
                <div className="relative">
                    ...
                    <div className="hidden md:block absolute left-1/2 top-0 bottom-0 -translate-x-1/2">
                        <div className="relative w-[2px] h-full">
                            <div className="absolute inset-0 border-l-2 border-dashed border-[#6F74B8]" />
                            <motion.div
                                className="absolute top-0 left-1/2 -translate-x-1/2 w-[2px] bg-[#6F74B8]"
                                style={{ originY: 0 }}
                                initial={{ height: 0 }}
                                animate={{
                                    height: `${
                            ...
                            return (
                                ...
                                >
                                            ...
                                            <motion.div
                                                className={`w-4 h-4 rounded-full border-2 bg-section-light ${
                                                    isCompleted || isActive
                                                        ? 'shadow-[0_0_0_6px_rgba(111,116,184,0.45)]'
                                                        : ''
                                                }`}
                                                animate={
                                                    isCompleted || isActive
                                                        ? {
                                                              borderColor: '#6F74B8',
                                                              backgroundColor: '#6F74B8',
                                                          }
                                                        : {
                                                              borderColor: 'rgba(111,116,184,0.5)',
                                    ...
                                    >
                                        ...
                                        >
                                             <div className="flex items-start gap-3 mb-3 text-xs md:text-sm text-[#E2E3F1] uppercase tracking-[0.2em]">
                                                 <span className="text-[#B6B8DB] font-semibold">
                                                    {step.number}
                                                </span>
                                                 <span className="text-white">{step.title}</span>
                                            </div>
                                             <p className="text-xs md:text-sm text-[#E2E3F1] leading-relaxed mb-4 whitespace-pre-line">
                                                {step.description}
                                            </p>
