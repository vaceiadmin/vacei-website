    ...
    <section className="relative z-50 w-full overflow-hidden py-6 sm:py-8 lg:py-12">
      <div className="relative z-10 w-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl">
          <GradientContainer
            className="min-h-80 sm:min-h-[24rem] lg:h-[22.5rem] lg:max-h-[22.5rem] rounded-lg shadow-[inset_4px_4px_24px_var(--primary-blue-shadow),inset_-4px_-4px_24px_var(--primary-blue-shadow)] bg-primary"
            showRadials={false}
          >
