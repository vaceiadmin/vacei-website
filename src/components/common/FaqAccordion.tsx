      ...
      <div className="mx-auto">
          <div className="flex flex-col gap-6 lg:gap-8 lg:flex-row lg:items-center max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div className="relative flex-1 flex items-center justify-center">
              <div className="relative w-full max-w-[400px] h-[500px] rounded-2xl overflow-hidden bg-[#181C42] shadow-xl">
                ...
                <div className="absolute bottom-6 left-6 z-10 max-w-[280px]">
                  ...
                  <div className="relative w-full h-6 -mb-1">
                    <svg className="w-full h-full text-[#6F74B8]" viewBox="0 0 280 24" preserveAspectRatio="none">
                      <path d="M0,24 Q140,0 280,24 L280,24 L0,24 Z" fill="currentColor" />
                    </svg>
                  </div>
                  
                  {/* Card */}
                  <div className="bg-[#6F74B8] rounded-t-2xl rounded-b-xl p-6 text-white shadow-lg">
