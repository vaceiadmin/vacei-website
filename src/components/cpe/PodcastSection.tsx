            ...
            >
                <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-10 lg:mb-12">
                        <SectionBadge text="Our Podcast" className="border-white text-white/80" />
                        ...
                        <p className="mt-3 text-sm md:text-base text-light-gray max-w-2xl mx-auto leading-relaxed">
                            The VACEI podcast features conversations on professional practice, regulation and business
                            operations.
                        </p>
                    </div>

                    {/* Main card */}
                    <div className="bg-black/20 backdrop-blur-md rounded-2xl overflow-hidden border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
                            ...
                            return (
                                <div
                                    ...
                                    className={`flex flex-col md:flex-row border-t border-white/10 transition-all duration-300 cursor-pointer ${
                                        isActive
                                            ? 'bg-purple-bg/80'
                                            : 'bg-gradient-to-r from-[#15163A] to-[#15163A]'
                                    } ${isFirst ? 'border-t-0' : ''}`}
                                >
                                    {/* Left label */}
                    ...
                    <div className="mt-10 lg:mt-12 text-center">
                        <p className="text-sm md:text-base text-light-gray max-w-xl mx-auto mb-5 leading-relaxed">
                            Learn more about VACEI supports business with accounting, audit and compliance service.
                        </p>
