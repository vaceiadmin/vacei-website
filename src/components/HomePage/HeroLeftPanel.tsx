        ...
        <div className="mt-auto mb-10 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 z-20">
          ...
          <div className="max-w-[480px] lg:text-right lg:mr-4 lg:mb-4">
            <p className="text-[16px] leading-[1.8] text-light-gray font-normal">
              VACEI is a modern accounting, audit and corporate services firm
              built around one structured digital platform. We handle
              accounting, compliance, corporate and audit work end to end, using
              our own technology to deliver clarity, speed and visibility. VACEI
              is not DIY software and not a marketplace. We are a professional
              firm that does the work for you, supported by a secure client
              portal.
            </p>
          </div>
        </div>
