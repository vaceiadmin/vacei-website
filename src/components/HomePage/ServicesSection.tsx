...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="w-full bg-white py-24 sm:py-32 relative overflow-hidden rounded-[48px]">
                ...
                <div className="flex gap-6 lg:gap-8 justify-center min-h-[500px]">
                        {displayItems.map((item, idx) => {
                            return (
                                ...
                                >
                                    <div className="relative h-[520px] rounded-[2.5rem] bg-white border border-slate-100 overflow-hidden transition-all duration-500 hover:border-blue-500/50 hover:shadow-[0_40px_80px_-20px_rgba(37,99,235,0.15)] group-hover:-translate-y-2">
                                        {/* Header area */}
                                        <div className="h-[55%] relative flex items-center justify-center p-8 bg-slate-50/50">
                                            {activeTab === "services" ? (
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 p-8 pt-20 bg-white">
                                            ...
                                            <Link 
                                                href={item.link}
                                                className="inline-flex items-center gap-3 text-xs font-black uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-colors"
                                            >
                                                Explore Phase
                                                <div className="w-10 h-10 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center group-hover:bg-blue-600 group-hover:border-blue-500 group-hover:text-white transition-all duration-300">
