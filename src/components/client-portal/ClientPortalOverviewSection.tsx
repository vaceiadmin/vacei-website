...
const ClientPortalOverviewSection = ({
  ...
  const renderLeftCard = () => {
    ...
    const isIntegratedDelivery =
      isAccounting && firstSectionTitle === "Integrated delivery environment";
                    ...
                    {[
                      ...
                      >
                        ...
                        <span className="text-right">
                          <button className="inline-flex rounded-full border border-input bg-icon px-3 py-0.5 text-[9px] font-semibold text-primary-blue">
                            Upload
                          </button>
                        </span>
                      </div>
        ...
        >
          <div className="relative rounded-[32px]  min-h-[340px] md:min-h-[380px]">
            ...
            <div className="absolute bottom-0 right-0  w-[76%] md:w-[56%] bg-white rounded-2xl border border-input shadow-[0_28px_50px_rgba(15,23,42,0.45)] px-5 py-4">
              ...
              <p className="text-[10px] text-gray mb-4">Viverra tristique</p>
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1 text-[10px] text-gray">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <span className="h-2 w-2 rounded-full bg-progress-purple" />{" "}
                    12
                  </span>
                </div>
              </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[0.9fr_1.2fr] gap-5 items-start">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    >
                      ...
                      <button className="px-3 py-1 rounded-full bg-primary text-white text-[10px] font-semibold shadow-primary-blue">
                        Open
                      </button>
                    </div>
                  ))}
            ...
            <div className="bg-white rounded-2xl px-4 py-4 shadow-xl border border-[#E3E4F0] text-[11px] text-[#1C2340]">
              ...
              <div className="space-y-2">
                {["Q1 2025", "Q2 2025", "Q3 2025", "Q4 2025"].map(
                  (period, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between rounded-xl bg-icon px-3 py-2"
                    >
                      ...
                      <button className="px-3 py-1 rounded-full bg-primary text-white text-[10px] font-semibold border border-[#D3D5EE] shadow-lg">
                        View
                      </button>
                    </div>
                  ),
