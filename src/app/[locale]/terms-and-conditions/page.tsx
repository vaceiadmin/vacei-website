...
const TermsAndConditionsPage = () => {
  const { t } = usePagesTranslation("terms-and-conditions");
  return (
  ...
  <div data-custom-class="body">
    <div style={{ textAlign: "left" }}>
      ...
      >
        ...
        <div className="question">
          <strong>February 13, 2026</strong>
        </div>
      </div>
    ...
    <div style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          We are{" "}
          <div
            className="question noTranslate"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="question noTranslate">Malta</div>
                    <div className="statement-end-if-in-editor">
                      <span
                        style={{
                          fontSize: "11.0pt",
                ...
                at <div className="question noTranslate">Triq San Giljan</div>
                <div className="block-component" />
              </span>
            </span>
            , <div className="question noTranslate">San Gwann</div>
          </span>
        </span>
    ...
    <div style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <div className="question noTranslate">
              <a
                target="_blank"
                data-custom-class="link"
                href="https://vacei.vercel.app"
              >
                https://vacei.vercel.app
              </a>
            </div>
          </span>{" "}
          (the <div className="block-component" />'<strong>Site</strong>'
          <div className="else-block" />)<div className="block-component" />
          ...
          <div className="else-block" />) (collectively, the{" "}
      ...
      >
        ...
        >
          ...
          <div className="block-component">
            ...
            <div className="question noTranslate">Triq San Giljan</div>
            <div className="block-component" />,{" "}
            <div className="question noTranslate">San Gwann</div>
            <div className="block-component" />
            <div className="block-component" />
      ...
      >
        ...
        >
          ...
          <div className="block-component" />'<strong>y</strong>
          <strong>ou</strong>'<div className="else-block" />
          ), and <div className="question noTranslate">Vacei</div>, concerning
    ...
    <div style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <div className="block-component" />
          'AS IS'
          <div className="else-block" /> for your{" "}
          <div className="block-component" />
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <div className="block-component" />'<div className="else-block" />
        </span>
        <a data-custom-class="link" href="#prohibited">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
        ...
        <span style={{ fontSize: 15 }}>
          ...
          revocable <div className="block-component" />
          licence
    ...
    <div style={{ textAlign: "left" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          licence
          <div className="else-block" /> to: use, copy, reproduce, distribute,
          ...
          works, your Contributions, and to <div className="block-component" />
          sublicence the licences
          <div className="else-block" /> granted in this section. Our use and
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          licence
          <div className="else-block" /> includes our use of your name, company
    ...
    <div style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <div className="question noTranslate">Visa</div>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <div className="forloop-component" />- &nbsp;
          <div className="question noTranslate">Mastercard</div>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          <div className="forloop-component" />- &nbsp;
          <div className="question noTranslate">PayPal</div>
        </span>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          in <div className="question">Euros</div>.
        </span>
      </div>
    </div>
    <div style={{ lineHeight: "1.5" }}>
    ...
    <div style={{ textAlign: "left", lineHeight: "1.5" }}>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <div className="block-component" />
          cancelled
          <div className="else-block" />. You consent to our charging your
      ...
      >
        <span style={{ fontSize: 15 }}>
          We offer a <div className="question">__________</div>-day free trial
          to new users who register with the Services.{" "}
          <div className="block-component" />
          <div className="question">__________</div> at the end of the free
          trial.
          <div className="else-block" />
        </span>
      </div>
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <div className="block-component" />
          licence
          <div className="else-block" /> agreement (
          <div className="block-component" />
          'EULA'
          <div className="else-block" />
          ...
          <div className="block-component" />
          licence
          <div className="else-block" /> to use such software solely in
          connection with our services and in accordance with these Legal Terms.
          Any software and any related documentation is provided{" "}
          <div className="block-component" />
          'AS IS'
          <div className="else-block" /> without warranty of any kind, either
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="block-component" />
            endeavours
            <div className="else-block" /> except those that are specifically
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          unauthorised
                          <div className="else-block" /> framing of or linking
                          to the Services.
                        </span>
                      </span>
                    </span>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          unauthorised
                          <div className="else-block" /> use of the Services,
              ...
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 14 }}>
                  <span data-custom-class="body_text">
                    ...
                    <div className="block-component" />
                    licences
                    <div className="else-block" />, rights, consents, releases,
                    and permissions to use and to{" "}
                    <div className="block-component" />
                    authorise
                    <div className="else-block" /> us, the Services, and other
              ...
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 14 }}>
                  <span data-custom-class="body_text">
                    ...
                    <div className="block-component" />
                    unauthorised
                    <div className="else-block" /> advertising, promotional
              ...
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 14 }}>
                  <span data-custom-class="body_text">
                    ...
                    <div className="block-component" />
                    libellous
                    <div className="else-block" />, slanderous, or otherwise
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="else-block" /> of the foregoing. The use and
            ...
            <div data-type="body">
              ...
              >
                ...
                >
                  This <div className="block-component" />
                  licence
                  <div className="else-block" /> will apply to any form, media,
            ...
            <div data-type="body">
              ...
              >
                ...
                >
                  ...
                  <div className="block-component" />
                  re-categorise
                  <div className="else-block" /> any Contributions to place them
    ...
    >
      ...
      >
        ...
        <div className="else-block" />) as well as articles, photographs, text,
        graphics, pictures, designs, music, sound, video, information,
        applications, software, and other content or items belonging to or
        originating from third parties (<div className="block-component" />
        'Third-Party Content'
        <div className="else-block" />
    ...
    >
      ...
      >
        ...
        <div className="question noTranslate">Vacei</div> and yourself both
        agree to submit to the non-exclusive jurisdiction of the courts of{" "}
        <div className="question noTranslate">__________</div>, which means that
        you may make a claim to defend your consumer protection rights in
        regards to these Legal Terms in <div className="block-component" />
        <div className="question noTranslate">Malta</div>
        <span
          style={{
            fontSize: "11pt",
    ...
    >
      <span style={{ fontSize: 15 }}>
        ...
        (individually, a <div className="block-component" />
        ...
        <div className="question">__________</div> days before initiating
    ...
    >
      ...
      <div className="question">__________</div>. The seat, or legal place, or
      arbitration shall be <div className="block-component" />
      <div className="block-component" />
      <div className="block-component" />
      <div className="question noTranslate">__________</div>
      <div className="statement-end-if-in-editor">
        <div className="statement-end-if-in-editor" />
        <div className="statement-end-if-in-editor" />
      </div>
      . The language of the proceedings shall be{" "}
      <div className="question noTranslate">__________</div>. The governing law
    ...
    >
      ...
      basis or to <div className="block-component" />
      utilise
      <div className="else-block" /> class action procedures; and (c) there is
    ...
    >
      ...
      <div className="block-component" />
      unauthorised
      <div className="else-block" /> use; and (c) any claim for injunctive
    ...
    >
      ...
      >
        ...
        <div className="block-component" />
        UNAUTHORISED
        <div className="else-block" /> ACCESS TO OR USE OF OUR SECURE SERVERS
        ...
        <div className="block-component" />
        JUDGEMENT
        <div className="else-block" /> AND EXERCISE CAUTION WHERE APPROPRIATE.
      </span>
    </div>
    <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
      <br />
                    ...
                    <div data-type="body">
                      ...
                      <div data-type="conditional-block">
                        <div
                          ...
                          data-type="statement"
                        />{" "}
                        OR <div className="block-component" />
                        <div className="block-component" />
                      </div>
                    </div>
                  </div>
    ...
    >
      ...
      >
        ...
        <div className="block-component" />
        defence
        <div className="else-block" /> and control of any matter for which you
        are required to indemnify us, and you agree to cooperate, at your
        expense, with our <div className="block-component" />
        defence
        <div className="else-block" /> of such claims. We will use reasonable
    ...
    >
      ...
      >
        ...
        <div className="block-component" />
        defences
        <div className="else-block" /> you may have based on the electronic form
  ...
  <div style={{ display: "none" }}>
    <a
      className="terms123"
      href="https://app.termly.io/dsar/4edaac29-e89c-4ce0-957a-ecafc1873d1a"
    />
  </div>
  <style
    dangerouslySetInnerHTML={{
